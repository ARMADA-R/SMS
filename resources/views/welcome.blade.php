...
<body class="sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed" style="height: auto;">
    <div class="wrapper">
            ...
            <div class="sidebar os-host os-theme-light os-host-overflow os-host-overflow-y os-host-resize-disabled os-host-scrollbar-horizontal-hidden os-host-transition">
               ...
               with font-awesome or any other icon font library -->
                ...
                <div class="os-scrollbar os-scrollbar-vertical os-scrollbar-auto-hidden">
                    <div class="os-scrollbar-track">
                        <div class="os-scrollbar-handle" style="height: 39.6371%; transform: translate(0px, 0px);"></div>
                    </div>
                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <div class="chart">
                                                ...
                                                <!-- Sales Chart Canvas -->
                                                <canvas id="salesChart" height="180" style="height: 180px; display: block; width: 510px;" width="510" class="chartjs-render-monitor"></canvas>
                                            </div>
                                            <!-- /.chart-responsive -->
                                        </div>
                                        <!-- /.col -->
                                    ...
                                    <div class="d-md-flex">
                                        <div class="p-1 flex-fill" style="overflow: hidden">
                                            ...
                                            <div id="world-map-markers" style="height: 325px; overflow: hidden" class="mapael">
                                                <div class="map"><svg height="210.29795828988532" version="1.1" width="340.094" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="overflow: hidden; position: relative; left: -0.5px;" viewBox="0 0 959 593" preserveAspectRatio="xMinYMin">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="chart-responsive">
                                                ...
                                                <canvas id="pieChart" height="71" width="142" style="display: block; width: 142px; height: 71px;" class="chartjs-render-monitor"></canvas>
                                            </div>
                                            <!-- ./chart-responsive -->
                                        </div>
                                        <!-- /.col -->
        ...
        <aside class="control-sidebar control-sidebar-dark">
            ...
            <div class="p-3 control-sidebar-content">
                ...
                <div class="mb-1"><input type="checkbox" value="1" class="mr-1"><span>Sidebar nav child hide on collapse</span></div>
                <div class="mb-1"><input type="checkbox" value="1" class="mr-1"><span>Main Sidebar disable hover/focus auto expand</span></div>
                <div class="mb-1"><input type="checkbox" value="1" class="mr-1"><span>Brand small text</span></div>
                ...
                <div class="d-flex flex-wrap mb-3">
                    ...
                    <div class="bg-warning elevation-2" style="width: 40px; height: 20px; border-radius: 25px; margin-right: 10px; margin-bottom: 10px; opacity: 0.8; cursor: pointer;"></div>
                    <div class="bg-white elevation-2" style="width: 40px; height: 20px; border-radius: 25px; margin-right: 10px; margin-bottom: 10px; opacity: 0.8; cursor: pointer;"></div>
                    <div class="bg-orange elevation-2" style="width: 40px; height: 20px; border-radius: 25px; margin-right: 10px; margin-bottom: 10px; opacity: 0.8; cursor: pointer;"></div><a href="#">clear</a>
                </div>
            </div>
        </aside>
        <!-- /.control-sidebar -->
    ...
    <script src="{{ url('/design/AdminLTE') }}/dist/js/pages/dashboard2.js"></script>
